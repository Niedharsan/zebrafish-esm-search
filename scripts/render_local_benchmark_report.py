...
def render(payload: Dict[str, Any]) -> str:
    ...
    lines = [
        ...
        "biological question and supplies their exact local gene symbols to the model. A later iteration added live authoritative retrieval "
        "from PubMed, Europe PMC, and QuickGO; UniProt and Ensembl remain the deterministic identifier-validation layer.",
        "",
        "A real run of the same prompt with authoritative retrieval returned 13 evidence records (4 Europe PMC, 4 PubMed, and 5 QuickGO) "
        "and validated all of these seeds:",
        "",
        "`csf1a`, `mif`, `mrc1a`, `marco`, `mpeg1.1`, `slc11a2`, `csf1r`, `macir`, `mmd2a`, `mst1ra`",
        "",
        "The resulting top five ESM neighbors were `mst1rb`, `mpeg1.2`, `kita`, `flt4`, and `pdgfra`. End-to-end latency was 88.14 seconds. "
        "The aggregate figures below remain the original pre-fix 24-question baseline; a complete post-fix rerun would be required before "
        "updating those aggregate measurements.",
        "",
